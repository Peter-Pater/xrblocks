...
function toGrayscale(imageBuffer) {
...
async function detect(message) {
    ...
    const count = wasm._atag_detect(message.intrinsics.fx, message.intrinsics.fy, message.intrinsics.cx, message.intrinsics.cy, message.tagSizeMeters);
