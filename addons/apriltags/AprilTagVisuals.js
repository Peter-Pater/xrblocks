...
import { DEFAULT_TAG25H9_SIZE_METERS } from './AprilTagTypes.js';
 ...
 */
function createAprilTagAnchorVisuals(options = {}) {
    const { tagSizeMeters = DEFAULT_TAG25H9_SIZE_METERS, axisLengthMeters = 0.12, axisRadiusMeters = 0.005, outlineThicknessMeters = 0.008, outlineColor = 0xffffff, } = options;
    ...
    const horizontal = new THREE.BoxGeometry(tagSizeMeters + thickness, thickness, thickness);
    const vertical = new THREE.BoxGeometry(thickness, tagSizeMeters + thickness, thickness);
...
export { createAprilTagAnchorVisuals };
