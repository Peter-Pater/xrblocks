...
export declare const APRILTAG_FAMILY: "tag25h9";
/** First valid ID in the tag25h9 family. */
export declare const TAG25H9_MIN_ID = 0;
/** Last valid ID in the tag25h9 family (35 tags total). */
export declare const TAG25H9_MAX_ID = 34;
/** Default tag selected by the demo. */
export declare const DEFAULT_TAG25H9_ID = 17;
/**
 ...
 */
export declare const DEFAULT_TAG25H9_SIZE_METERS = 0.1556;
/** The state of an {@link AprilTagTracker}'s persistent spatial anchor. */
export type AprilTagTrackingState = 'initializing' | 'searching' | 'tracked' | 'anchored' | 'error';
